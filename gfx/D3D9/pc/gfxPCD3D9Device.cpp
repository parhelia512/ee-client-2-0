...
{
   return new GFXPCD3D9Device( Direct3DCreate9( D3D_SDK_VERSION ), adapterIndex );
}
...
void GFXPCD3D9Device::init( const GFXVideoMode &mode, PlatformWindow *window /* = NULL */ )
{
   ...
   else 
   {
      ...
      // NOTE: We do not enabled D3D multithreading by default as it
      // adds a considerable amount of CPU cost.  In all cases you can
      // do better by locking/creating resources in the primary thread
      ...
      // This needs to be set for firefox on windows
