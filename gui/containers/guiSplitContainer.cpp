...
static EnumTable::Enums gSplitOrientationEnums[] =
{
   { GuiSplitContainer::Vertical, "Vertical" },
   { GuiSplitContainer::Horizontal, "Horizontal" }   
};
EnumTable gSplitOrientationEnumTable( 2, gSplitOrientationEnums );

static EnumTable::Enums gSplitFixedPanelEnums[] =
{
   { GuiSplitContainer::None, "None" },
   { GuiSplitContainer::FirstPanel, "FirstPanel" },
   { GuiSplitContainer::SecondPanel, "SecondPanel" }
};
EnumTable gSplitFixedPanelEnumTable( 3, gSplitFixedPanelEnums );
...
void GuiSplitContainer::initPersistFields()
{
   ...
   addField( "Orientation",   TypeEnum,   Offset( mOrientation, GuiSplitContainer), 1, &gSplitOrientationEnumTable, "Vertical/Horizontal Splitter" );
   addField( "SplitterSize",  TypeS32,    Offset( mSplitterSize, GuiSplitContainer), "The size of the splitter" );
   addField( "SplitPoint",    TypePoint2I, Offset( mSplitPoint, GuiSplitContainer), "The x/y is used depending on the orientation.  This value will change as the parent is resized." );
   addField( "FixedPanel",    TypeEnum,   Offset( mFixedPanel, GuiSplitContainer), 1, &gSplitFixedPanelEnumTable, "Which panel will stay fixed on parent resizing" );
...
GuiControl* GuiSplitContainer::findHitControl( const Point2I &pt, S32 initialLayer )
{
