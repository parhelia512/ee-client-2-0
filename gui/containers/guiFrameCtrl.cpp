...
ConsoleMethod( GuiFrameSetCtrl, framePadding, void, 7, 7, "(int index, int t, int b, int l, int r)")
{
   RectSpacingI padding( dAtoi( argv[3] ), dAtoi( argv[4] ), dAtoi( argv[5] ), dAtoi( argv[6] ) );
   object->framePadding(dAtoi(argv[2]), padding);
}
...
ConsoleMethod( GuiFrameSetCtrl, updateSizes, void, 2, 2, "()")
{
   object->updateSizes();
}
