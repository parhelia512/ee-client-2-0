...
#define CON_ADD_PARSER(prefix, ext, def) \
	...
	prefix##restart, prefix##SetScanBuffer,prefix##DestroyBuff, def)
...
//-----------------------------------------------------------------------------
bool addConsoleParser(char *ext, fnGetCurrentFile gcf, fnGetCurrentLine gcl, fnParse p, fnRestart r, fnSetScanBuffer ssb,fnDestroyBuffer db, bool def = false);
