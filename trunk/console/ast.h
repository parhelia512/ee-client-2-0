...
struct AssertCallExprNode : ExprNode
{
   ...
   static AssertCallExprNode *alloc( ExprNode *testExpr, const char *message );
   U32 precompile(TypeReq type);
   U32 compile(U32 *codeStream, U32 ip, TypeReq type);
   TypeReq getPreferredType();
...
struct ObjectDeclNode : ExprNode
{
   ...
   static ObjectDeclNode *alloc(ExprNode *classNameExpr, ExprNode *objectNameExpr, ExprNode *argList, StringTableEntry parentObject, SlotAssignNode *slotDecls, ObjectDeclNode *subObjects, bool isDatablock, bool classNameInternal, bool isSingleton);
   U32 precompile(TypeReq type);
