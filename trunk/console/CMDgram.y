...
object_decl
   ...
   | rwDECLARESINGLETON class_name_expr '(' object_name parent_block object_args ')' '{' object_declare_block '}'
      { $$ = ObjectDeclNode::alloc($2, $4, $6, $5, $9.slots, $9.decls, false, false, true); }
   | rwDECLARESINGLETON class_name_expr '(' object_name parent_block object_args ')'
      { $$ = ObjectDeclNode::alloc($2, $4, $6, $5, NULL, NULL, false, false, true); }
   ;
...
assert_expr
   : rwASSERT '(' expr ')'
      { $$ = AssertCallExprNode::alloc( $3, NULL ); }
   | rwASSERT '(' expr ',' STRATOM ')'
      { $$ = AssertCallExprNode::alloc( $3, $5 ); }
   ;
