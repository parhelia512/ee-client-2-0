...
// Note that the plane list provided MUST match the one in Frustum
extern bool (*m_planeF_intersect_box3F)(const F32 *planes, const F32 *bounds);
...
inline F32 mLerp( F32 v1, F32 v2, F32 factor )
{
