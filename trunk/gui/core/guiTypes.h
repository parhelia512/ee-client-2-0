...
public:
   ...
   U8				mStatu;
   void setPickedBmp(StringTableEntry path);
   void clearPickedBmp();
   //end rpg added
};
...
public:
   ...
   ColorI mCursorColor;                            ///< Color for the blinking cursor in text fields (for example)
	...
	S32 mYPositionOffset;                           ///< For guiWindow and guiWindowCollapsed ctrls in window resize mode
...
public:
   ...
   static bool protectedSetBitmap( void *obj, const char *data );
};
