...
void GuiFileTreeCtrl::initPersistFields()
{
   ...
   addProtectedField( "fileFilter", TypeRealString,   Offset( mFileFilter, GuiFileTreeCtrl ),
                      &_setFileFilterValue, &defaultProtectedGetFn, 1, NULL, "Vector of file patterns.  If not empty, only files matching the pattern will be shown in the control." );
   endGroup( "File Tree" );
...
bool GuiFileTreeCtrl::_setFileFilterValue( void* obj, const char* data )
{
   GuiFileTreeCtrl* ctrl = ( GuiFileTreeCtrl* ) obj;
