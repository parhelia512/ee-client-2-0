...
bool PostEffectManager::smRB3DEffects = false;
      ...
      mLastBackBufferTarget( NULL )
{
   ...
   SceneGraph::getPostRenderSignal().notify( this, &PostEffectManager::_onPostRenderPass );

   Con::addVariable("pref::enablePostEffects", TypeBool, &smRenderEffects);
   Con::addVariable("pref::enableRB3D", TypeBool, &smRB3DEffects);
}
...
PostEffectManager::~PostEffectManager()
{
   ...
   SceneGraph::getPostRenderSignal().remove( this, &PostEffectManager::_onPostRenderPass );
}
...
void PostEffectManager::_onPostRenderPass( SceneGraph *sceneGraph, const SceneState *sceneState )
{
...
void PostEffectManager::renderEffects( const SceneState *state,
