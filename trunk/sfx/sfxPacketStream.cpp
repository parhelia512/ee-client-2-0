...
#include "sfx/sfxPacketStream.h"
#include "platform/typetraits.h"
#include "console/console.h"


SFXPacketStream::SFXPacketStream( const SFXFormat& format,
...
void SFXPacketStream::reset()
{
   if( dynamic_cast< IResettable* >( getSourceStream() ) )
   {
      ...
      Con::errorf( "SFXPacketStream - cannot reset source stream" );
}

U32 SFXPacketStream::read( U8* buffer, U32 length )
{
   U32 bufferOffset = 0;
