...
void Vehicle::mountObject(SceneObject *obj, U32 node)
{
...
void Vehicle::prepBatchRender( SceneState *state, S32 mountedImageIndex )
{
...
void Vehicle::_renderMassAndContacts( ObjectRenderInst *ri, SceneState *state, BaseMatInstance *overrideMat )
{
...
void Vehicle::_renderMuzzleVector( ObjectRenderInst *ri, SceneState *state, BaseMatInstance *overrideMat )
{
