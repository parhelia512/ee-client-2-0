...
#pragma pack()
   ...
   public:
      ...
      virtual void set(void *b, dsize_t s, U32 n, bool autoFree = true ) { if(base && autoFree) dAligned_free(base); base = reinterpret_cast<U8 *>(b); vertSz = s; numElements = n; }
...
public:
   struct BatchData
   {
      ...
      public:
         ...
         virtual ~BatchedTransform() { if(alignedMem) dAligned_free(alignedMem); alignedMem = NULL; if(_tmpVec) delete _tmpVec; _tmpVec = NULL; }
      };
