...
void GuiMeshRoadEditorCtrl::initPersistFields()
{
   ...
   //addField( "MoveNodeCursor", TypeSimObjectPtr, Offset( mMoveNodeCursor, GuiMeshRoadEditorCtrl) );
   //addField( "AddNodeCursor", TypeSimObjectPtr, Offset( mAddNodeCursor, GuiMeshRoadEditorCtrl) );
   //addField( "InsertNodeCursor", TypeSimObjectPtr, Offset( mInsertNodeCursor, GuiMeshRoadEditorCtrl) );
   //addField( "ResizeNodeCursor", TypeSimObjectPtr, Offset( mResizeNodeCursor, GuiMeshRoadEditorCtrl) );
