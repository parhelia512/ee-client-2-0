...
bool GuiRiverEditorCtrl::onAdd()
{
   ...
   SceneGraph::getPreRenderSignal().notify( this, &GuiRiverEditorCtrl::_prepRenderImage );
...
void GuiRiverEditorCtrl::initPersistFields()
{
   ...
   //addField( "MoveNodeCursor", TypeSimObjectPtr, Offset( mMoveNodeCursor, GuiRiverEditorCtrl) );
   //addField( "AddNodeCursor", TypeSimObjectPtr, Offset( mAddNodeCursor, GuiRiverEditorCtrl) );
   //addField( "InsertNodeCursor", TypeSimObjectPtr, Offset( mInsertNodeCursor, GuiRiverEditorCtrl) );
   //addField( "ResizeNodeCursor", TypeSimObjectPtr, Offset( mResizeNodeCursor, GuiRiverEditorCtrl) );
...
void GuiRiverEditorCtrl::_prepRenderImage( SceneGraph* sceneGraph, const SceneState* state )
{
...
void GuiRiverEditorCtrl::_renderSelectedRiver( ObjectRenderInst *ri, SceneState *state, BaseMatInstance *matInst )
{
