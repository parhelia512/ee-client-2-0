...
class GuiRiverEditorCtrl : public EditTSCtrl
{
   ...
   protected:
      ...
      void _renderSelectedRiver( ObjectRenderInst *ri, SceneState *state, BaseMatInstance *matInst );
      void _prepRenderImage( SceneGraph* sceneGraph, const SceneState* sceneState );
