...
public:   
   ...
   F32 distanceToSurface( const Point3F &pnt, U32 nodeIdx );
   bool containsPoint( const Point3F &worldPos, U32 *nodeIdx = NULL );
...
protected:
   ...
   void _render( ObjectRenderInst *ri, SceneState *state, BaseMatInstance *matInst );
