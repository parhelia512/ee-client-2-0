...
#ifndef _SFXPACKETSTREAM_H_
#define _SFXPACKETSTREAM_H_
...
///
/// @note For the SFXPacketStream to allow a reset(), the source input
///   stream must implement IResettable.
class SFXPacketStream : public SFXStream,
                        public IInputStreamFilter< U8, IInputStream< RawData* >* >
{
   ...
   public:
      ...
      ///
      SFXPacketStream( const SFXFormat& format, SourceStreamType* stream, U32 numSamples = U32_MAX );
