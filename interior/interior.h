...
//   void debugShowVertexColors(MaterialList* pMaterials);      
  ...
  private:
   ...
   void renderZoneNode( SceneState *state,
                        RenderNode &node,
                        InteriorInstance *intInst,
                        SceneGraphData &sgData,
                        MeshRenderInst *coreRi );

   void renderReflectNode( SceneState *state,
                           ReflectRenderNode &node,
                           InteriorInstance *intInst,
                           SceneGraphData &sgData,
                           MeshRenderInst *coreRi );

   void renderLights(SceneState* state, InteriorInstance *intInst, SceneGraphData &sgData, MeshRenderInst *coreRi, const ZoneVisDeterminer &zonevis);
