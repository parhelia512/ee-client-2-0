...
Vector<MeshRenderInst *> g_renderInstList;
Vector<MeshRenderInst *> *InteriorSimpleMesh::renderInstList = &g_renderInstList;//new Vector<MeshRenderInst *>();
...
void InteriorSimpleMesh::render( SceneState* state, 
