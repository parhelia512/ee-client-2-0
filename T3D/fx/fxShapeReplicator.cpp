...
void fxShapeReplicator::initPersistFields()
{
   ...
   addGroup( "Media" );	// MM: Added Group Header.
      addField( "ShapeFile",           TypeFilename,  Offset( mFieldData.mShapeFile,            fxShapeReplicator ), "Filename of shape to replicate." );
...
void fxShapeReplicator::renderObject(ObjectRenderInst *ri, SceneState *state, BaseMatInstance* overrideMat)
{
   if (overrideMat)
      return;
