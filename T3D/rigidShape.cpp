...
void RigidShape::prepBatchRender( SceneState *state, S32 mountedImageIndex )
{
...
void RigidShape::_renderMassAndContacts( ObjectRenderInst *ri, SceneState *state, BaseMatInstance *overrideMat )
{
