...
#include "T2D/networking/t2dMoveManager.h"
#include "T2D/model/ModelNodeFactoryCache2D.h"
#include "T2D/model/ModelControllerFactoryCache2D.h"
#endif
...
#ifdef TORQUE_TGB_ONLY
   ModelNodeFactoryCache2D::createSingleton();
   ModelControllerFactoryCache2D::createSingleton();
#endif
...
#ifdef TORQUE_TGB_ONLY
   ModelNodeFactoryCache2D::instance()->flushTotalCache();
   ModelNodeFactoryCache2D::deleteSingleton();
   ModelControllerFactoryCache2D::instance()->flushTotalCache();
   ModelControllerFactoryCache2D::deleteSingleton();
#endif
