...
DECLARE_CONSOLETYPE( PxMultiActorData )
...
protected:
   ...
   /// Creates a PxJointUserData and parses userProperties into it.
   PxJointUserData* _createJointUserData( NxJoint *joint, String &userProperties );

   /// Creates a PxActorUserData and parses userProperties into it.
