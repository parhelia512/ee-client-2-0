...
class TSShapeInstance
{
   ...
   struct ObjectInstance
   {
     ...
     /// Render!  This draws the base-textured object.
      virtual void render( S32 objectDetail, TSMaterialList *, const TSRenderState &rdata );      
     /// @}
   ...
   struct MeshObjectInstance : ObjectInstance
   {
      ...
      /// @{
      void render( S32 objectDetail, TSMaterialList *, const TSRenderState &rdata);
      /// @}
...
//-------------------------------------------------------------------------------------
   ...
   S32 setDetailFromPosAndScale( const SceneState *state, 
                                 const Point3F &pos, 
                                 const Point3F &scale );
   ...
   ///
   /// Internally this calls setDetailFromPixelSize or if the first
   /// detail's 'maxError' is non-zero, setDetailFromScreenError.
   ///
   /// @see TSShape::Detail.
   S32 setDetailFromDistance( const SceneState *state, F32 scaledDist );

   /// Sets the current detail level from the size of
   /// your object in screen space pixels.
   S32 setDetailFromPixelSize( F32 pixelSize );

   /// Sets the current detail level using a screen error metric.
