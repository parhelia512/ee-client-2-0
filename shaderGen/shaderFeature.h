...
public:
   ...
   virtual void setConsts( SceneState *state, 
...
public:
   ...
   */
   ...
   //
   virtual ShaderFeatureConstHandles* createConstHandles( GFXShader *shader ) { return NULL; }

   /// Called after processing the vertex and processing the pixel 
   /// to cleanup any temporary structures stored in the feature.
   virtual void reset() { output = NULL; mProcessIndex = 0; }
