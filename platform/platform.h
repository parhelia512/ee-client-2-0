...
/// This macro is used to execute code during static initialization
/// when the executable is starting up.
///
/// OnTorqueStartup
/// {
///    // Your code here!
/// }
///
#define OnTorqueStartup                                       \
   namespace { struct _StaticStartup { _StaticStartup(); }; }  \
   static const _StaticStartup _staticStartup;                 \
   _StaticStartup::_StaticStartup()


/// This macro is used to execute code during static destruction
/// when the executable is shutting down.
///
/// OnTorqueShutdown
/// {
///    // Your code here!
...
extern void *dAligned_malloc(dsize_t in_size, dsize_t alignment);
extern void dAligned_free(void*);
